...
class FBPrintViewHierarchyCommand(fb.FBCommand):
    ...
    def options(self):
        return [fb.FBCommandArgument(short='-u', long='--up', arg='upwards', boolean=True, default=False,
                                     help='Print only the hierarchy directly above the view, up to its window.')]

    def args(self):
        return [fb.FBCommandArgument(arg='aView', type='UIView*', help='The view to print the description of.',
                                     default='(id)[UIWindow keyWindow]')]
...
class FBPrintViewControllerHierarchyCommand(fb.FBCommand):
    ...
    def args(self):
        return [fb.FBCommandArgument(arg='aViewController', type='UIViewController*',
                                     help='The view controller to print the description of.',
                                     default='(id)[(id)[UIWindow keyWindow] rootViewController]')]
...
class FBPrintUpwardResponderChain(fb.FBCommand):
    ...
    def args(self):
        return [fb.FBCommandArgument(arg='startResponder', type='UIResponder *',
