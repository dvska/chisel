...
class FBDrawBorderCommand(fb.FBCommand):
    ...
    def options(self):
        return [
            fb.FBCommandArgument(short='-c', long='--color', arg='color', type='string', default='red',
                                 help='A color name such as \'red\', \'green\', \'magenta\', etc.'),
            fb.FBCommandArgument(short='-w', long='--width', arg='width', type='CGFloat', default=2.0,
...
class FBMaskViewCommand(fb.FBCommand):
    ...
    def options(self):
        return [
            fb.FBCommandArgument(short='-c', long='--color', arg='color', type='string', default='red',
                                 help='A color name such as \'red\', \'green\', \'magenta\', etc.'),
            fb.FBCommandArgument(short='-a', long='--alpha', arg='alpha', type='CGFloat', default=0.5,
