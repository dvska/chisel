...
class FBFindViewCommand(fb.FBCommand):
    ...
    def args(self):
        return [fb.FBCommandArgument(arg='classNameRegex', type='string',
...
class FBFindViewByAccessibilityLabelCommand(fb.FBCommand):
    ...
    def args(self):
        return [fb.FBCommandArgument(arg='labelRegex', type='string',
...
class FBTapLoggerCommand(fb.FBCommand):
    ...
    def run(self, arguments, options):
        ...
        lldb.debugger.HandleCommand(
            'breakpoint command add -s python -F "sys.modules[\'' + __name__ + '\'].' + self.__class__.__name__ + '.taplog_callback" ' + str(
                breakpoint.id))
